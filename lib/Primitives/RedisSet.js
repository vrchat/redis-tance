...
class RedisSet{
    ...
    async union(...setIds){
        return this.tance.sunion(...[this.id].concat(this.forceSetIds(setIds)));
    }
    ...
    async unionStore(...setIds){
        ...
        await this.tance.sunionstore(newSet.id, ...[this.id].concat(this.forceSetIds(setIds)));
        return newSet;
    }

    async intersect(...setIds){
        return this.tance.sinter(...[this.id].concat(this.forceSetIds(setIds)));
    }
    ...
    async intersectStore(...setIds){
        ...
        await this.tance.sinterstore(newSet.id, ...[this.id].concat(this.forceSetIds(setIds)));
        return newSet;
    }


    async diff(...setIds){
        return this.tance.sdiff(...[this.id].concat(this.forceSetIds(setIds)));
    }
    ...
    async diffStore(...setIds){
        ...
        await this.tance.sdiffstore(newSet.id, ...[this.id].concat(this.forceSetIds(setIds)));
        return newSet;
    }
