...
class ExpiringSet {
    ...
    async listExpiredEntries(){
        /*
            if we diff the old list and the new list, we should be able to produce a list of elements
            that won't survive the expiration.
         */

        return this.set_B.diff(this.set_A.id);
    }
